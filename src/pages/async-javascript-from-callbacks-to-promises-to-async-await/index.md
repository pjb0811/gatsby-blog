---
title: 비동기 자바 스크립트의 진화 - Callbacks에서 Promises, Async / Await
date: '2018-10-31'
...
> _저는 당신이 콜백에 대해 정확히 알고 있다고 가정하겠습니다. 제가 잘못 생각하고 있다면, 그냥 좀 스크롤을 내려 주세요._
...
```javascript
// updateUI 및 showError는 관련이 없습니다.
...
```javascript
// updateUI, showError 및 getLocationURL은 관련이 없습니다.
// 그들은 말하는 대로 하는 척만 합니다.
...
콜백의 다음 문제는 [통제의 역행](https://en.wikipedia.org/wiki/Inversion_of_control)과 관련이 있다. 콜백을 작성할 때, 콜백을 주고있는 프로그램이 책임이 있으며 프로그램이 정상적으로 작동 할 때(예정되어있을 때) 호출 할 것이라고 가정하고 있습니다.
